...
public class GreatTest() : PageTest
{
    ...
    public async Task InteractiveTest()
    {
        ...
        // Wait but this test shouldn't pass. We can document this by running the exact same thing again.

        await Expect(Page.GetByTestId("message")).ToContainTextAsync("fail");
